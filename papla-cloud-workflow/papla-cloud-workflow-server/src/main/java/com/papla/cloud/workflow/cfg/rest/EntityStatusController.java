...
/**
* @Title: EntityStatusController.java
...
@Api(tags = "实体状态管理")
@RequestMapping("/cfg/entityStatus")
public class EntityStatusController {

	private final EntityStatusService service;
	
	@Log("查询【实体状态】")
	@ApiOperation("查询【实体状态】数据")
	@ApiImplicitParams({})
	@PostMapping(value="page")
	public ResponseEntity<TabPage<EntityStatus>> page(@RequestBody Map<String, Object> param) throws Exception{
		return new ResponseEntity(service.selectForPage(param), HttpStatus.OK);
	}
	
	@Log("保存【实体状态】")
	@ApiOperation("保存【实体状态】数据")
	@PostMapping(value="save")
	public ResponseEntity<EntityStatus> save(@RequestBody EntityStatus entity) throws Exception{
		return new ResponseEntity(service.saveOrUpdate(entity), HttpStatus.OK);
	}
	
	@Log("批量保存【实体状态】")
	@ApiOperation(value = "批量保存【实体状态】数据")
	@PostMapping(value="batchSave")
	public ResponseEntity<SaveModel<EntityStatus>> batchSave(@RequestBody SaveModel<EntityStatus> entity){
	    return new ResponseEntity(service.batchSaveOrUpdate(entity), HttpStatus.OK);
	}
	
	@Log("删除【实体状态】")
	@ApiOperation(value = "删除【实体状态】数据")
	@ApiImplicitParams({
