...
/**
* @Title: ProcDesignController.java
...
@Api(tags = "设计流程管理")
@RequestMapping("/cfg/procDesign")
public class ProcDesignController {

	private final ProcDesignService service;
	
	@Log("查询【设计流程】")
	@ApiOperation("查询【设计流程】数据")
	@ApiImplicitParams({})
	@PostMapping(value="page")
	public ResponseEntity<TabPage<ProcDesign>> page(@RequestBody Map<String, Object> param) throws Exception{
		return new ResponseEntity(service.selectForPage(param), HttpStatus.OK);
	}
	
	@Log("保存【设计流程】")
	@ApiOperation("保存【设计流程】数据")
	@PostMapping(value="save")
	public ResponseEntity<ProcDesign> save(@RequestBody ProcDesign entity) throws Exception{
		return new ResponseEntity(service.saveOrUpdate(entity), HttpStatus.OK);
	}
	
	@Log("批量保存【设计流程】")
	@ApiOperation(value = "批量保存【设计流程】数据")
	@PostMapping(value="batchSave")
	public ResponseEntity<SaveModel<ProcDesign>> batchSave(@RequestBody SaveModel<ProcDesign> entity){
	    return new ResponseEntity(service.batchSaveOrUpdate(entity), HttpStatus.OK);
	}
	
	@Log("删除【设计流程】")
	@ApiOperation(value = "删除【设计流程】数据")
	@ApiImplicitParams({
