...
/**
* @Title: EntityStatusService
* @Description: TODO 实体状态管理
* @author 
* @date 2021-09-29
* @version V1.0
*/
public interface EntityStatusService extends BaseService<EntityStatus>{
	...
	* @throws IOException
	*/
	void download(List<EntityStatus> entitys, HttpServletResponse response) throws IOException;
