 ...
 * @author zhangfj
 * @version V1.0
 * @Title: CodeTempCfgController.java
...
@Api(tags = "【模板配置】管理")
@RequestMapping("/code/codeTempCfg")
public class CodeTempCfgController {

    private final CodeTempCfgService service;

    @Log("查询【模板配置】数据")
    @ApiOperation("查询【模板配置】数据")
    @RequestMapping(value = "page", method = RequestMethod.POST)
    public ResponseEntity<TabPage<CodeTempCfg>> page(@RequestBody Map<String, Object> param) throws Exception{
    ...
    public ResponseEntity<SaveModel<CodeTempCfg>> batchSave(@RequestBody SaveModel<CodeTempCfg> entity){
    ...
    public ResponseEntity<CodeTempCfg> save(@RequestBody CodeTempCfg entity) throws Exception{
    ...
    public ResponseEntity<CodeTempCfg> load(String id) {
